...
seqtype = 1
aaRatefile = /home/jlkang/software/paml/dat/jones.dat # change it according to your PAML install directory
fix_kappa = 0
kappa = 2
Malpha = 0
ncatG = 3
...
sub print_fixed_para {
        ...
        print OUTPUT "aaRatefile = /home/jlkang/software/paml/dat/jones.dat\n";
