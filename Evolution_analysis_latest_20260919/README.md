...
# 富集分析
# 首先将Uniprot ID转换成Entrez gene symbols
# 背景：所有可被注释的paml input genes
# (base) kangjingliang@KangdeMacBook-Pro-2 一  9 21 2026 12:00:44 ~/Documents/2025/Nocturnal_fish
less final_orth_input_paml_anno.txt|perl -alne 'my @a=split /\|/, $F[2];print "$a[1]"' > final_orth_input_paml_anno_UniID.txt
# 将final_orth_input_paml_anno_UniID.txt上传至https://www.uniprot.org/id-mapping进行ID转换
# UniProtKB AC/ID ==> Gene_Name；结果文件：final_UniID_convertion.xlsx

# PSGs
# (base) kangjingliang@KangdeMacBook-Pro-2 一  9 21 2026 12:19:46 ~/Documents/2025/Nocturnal_fish/Hyphy_PSGs
less Hyphy_PSGs_anno.txt|perl -alne 'my @a=split /\|/, $F[1];print "$a[1]"' > Hyphy_PSGs_anno_UniID.txt

# Relax
less Hyphy_relax_genes_fdr_sig_anno.txt|perl -alne 'my @a=split /\|/, $F[1];print "$a[1]"' > Hyphy_relax_anno_UniID.txt

# caas
# (base) kangjingliang@KangdeMacBook-Pro-2 二  9 22 2026 11:10:18 ~/Documents/2025/Nocturnal_fish/caas
